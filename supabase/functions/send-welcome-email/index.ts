            ...
            <div style="background: #f8fafc; padding: 30px; border-top: 1px solid #e5e7eb;">
              <div style="text-align: center; margin-bottom: 24px;">
                ...
                <div style="display: inline-block;">
                  <a href="https://linkedin.com/company/apptheta" style="display: inline-block; margin: 0 8px; text-decoration: none;">
                    <img src="https://theta.co.in/icons/linkedin-icon.png" alt="LinkedIn" style="width: 24px; height: 24px;">
                  </a>
                  <a href="https://instagram.com/theta.app_" style="display: inline-block; margin: 0 8px; text-decoration: none;">
