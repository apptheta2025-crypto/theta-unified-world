  ...
  return <section className="py-16 lg:py-24 bg-gradient-subtle">
      <div className="container-wide">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => <div key={index} className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-6 hover:bg-card/80 transition-all duration-300 hover:shadow-lg">
              <div className="mb-4">
                {benefit.icon}
              </div>
