          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild size="lg" className="bg-gradient-cta hover:shadow-glow transition-all duration-300 font-bold py-6 shadow-2xl hover:scale-105 relative overflow-hidden group rounded-full">
                <a href="https://create.theta.co.in" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center px-[47px] gap-0 border border-solid border-muted-foreground bg-white/20 rounded-full">
